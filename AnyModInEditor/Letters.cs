...
namespace AnyModInEditor
{
    class Letters
    {
        ...
        {
            Texture2D res = new Texture2D(10, 10);
        ...
        public static Sprite CreateSprite(Sprite sprite, string name) =>  Sprite.Create(CreateTexture(sprite.texture, name), sprite.rect, sprite.pivot);
        ...
        public static Texture2D CreateTexture(Texture2D prefab, string name)
        {
            ...
            if (prefab == null) textureResult = new Texture2D(32, 32);
            else
            {
                textureResult = new Texture2D(prefab.width, prefab.height);
                textureResult.SetPixels(prefab.GetPixels());
            }
            int xAdd = 0;
            int yAdd = 20;
